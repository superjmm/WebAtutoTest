...
class TestZzjg():   
    ...
    def test_add_zzjg(self,case):
        ...
        add_row += 1  
        n = add_row   
        case_id,case_name,is_execute,preconditon,depend_key,data,expect_result,test_result= case
    ...
    def test_update_zzjg(self,case):
        ...
        if case_id is None: #用例编号不能为空
            ...
            result = zzjg_manage.update(data)
            if result:
    ...
    def test_delete_zzjg(self,case):
        ...
        if case_id is None: #用例编号不能为空
            ...
            result = zzjg_manage.delete(data)
            if result:
